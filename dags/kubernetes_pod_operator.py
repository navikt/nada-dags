...
with DAG('KubernetesPodOperator', start_date=datetime(2023, 2, 15), schedule=None) as dag:
    ...
    task_1 = KubernetesPodOperator(
        ...
        cmds=["/bin/sh", "-c"],
        arguments=["""time sleep 10 && python -c "from kafka import KafkaProducer; producer = KafkaProducer(bootstrap_servers='nav-prod-kafka-nav-prod.aivencloud.com:26484', security_protocol='SSL')" """],
